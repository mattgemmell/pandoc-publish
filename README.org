...
This configuration is [[https://github.com/mattgemmell/pandoc-novel/][available on github]]. It is released under the *[[https://www.gnu.org/licenses/gpl-3.0.en.html][GPL-3.0 license]]*, with the exception of the demonstration projects (in the =/demo= and =/demo-nonfiction= directories) which are released under the public domain *[[https://creativecommons.org/publicdomain/zero/1.0/][CC0 Universal license]]*.
